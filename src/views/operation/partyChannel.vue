			...
			<div slot="header" class="header">
				<el-form :inline="true" :model="form" @submit.native.prevent>
		  			...
		  			<el-form-item label="渠道名">
		  		   		<el-input v-model="form.SourceName" placeholder="请输入" clearable style="width:170px;"></el-input>
		  			</el-form-item>
...
import { jiachannellist,companyinfo } from 'api/api.js';
export default {
	data(){
		return {
			pickerOptions:{
...
<style lang="scss">
	#partyChannel{ min-width:1200px; padding:20px; box-sizing:border-box; overflow:scroll;
