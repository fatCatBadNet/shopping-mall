		...
		<el-card class="box-card">
			...
			<template>
				<el-table :data="tableData"  v-loading="listLoading" element-loading-text="数据加载中..." border>
					...
					<el-table-column prop="NumCertOnDay" label="认证用户" min-width="120"></el-table-column>
					<el-table-column prop="NumLoanApply" label="申请借款" min-width="120" :render-header="(h,obj) => renderHeader(h,obj,'用户申请借款的数量')"></el-table-column>
					<el-table-column prop="NumLoanSuccessOnDay" label="借款通过" min-width="120" :render-header="(h,obj) => renderHeader(h,obj,'成功放款用户的数量')"></el-table-column>
