		...
		<el-card class="box-card">
			<div slot="header" class="header">
				<el-form :inline="true" :model="form" @submit.native.prevent>
		  			...
		  			<span style="float:right;margin-right: 100px;display: inline-block;padding-top: 20px;color:#3F51B5;font-size:14px;">提示：若语音内容要更改，请联系客服人员</span>
		  		</el-form>
			</div>
			<template>
				<el-table :data="tableData" v-loading="listLoading" element-loading-text="数据加载中..." border style="width:100%;">
                    ...
                    <el-table-column label="录音文件" width="350px" >
                        <template slot-scope="scope">

                                <audio  controls="controls">  
                                        <source :src="scope.row.CallUuid">
                                </audio>
								<!-- <span >录音文件已失效</span> -->
                        </template>
